    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Dimana Anda Ingin Membuka Toko Anda',
              style: TextStyle(
                fontSize: 24,
                ...
                itemBuilder: (context, index) {
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      title: Text('Nama Toko $index'),
                      subtitle: Text('Alamat Toko $index'),
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => LocationDescriptionScreen(
                              locationName: 'Nama Toko $index',
                              locationAddress: 'Alamat Toko $index',
