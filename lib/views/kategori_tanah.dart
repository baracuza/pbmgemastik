              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Card(
                    ...
                    child: ListTile(
                      leading: Icon(Icons.layers, size: 40),
                      title: Text('Nama Tanah $index'),
                      subtitle: Text('Alamat Tanah $index'),
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => LocationDescriptionScreen(
                              locationName: 'Nama Tanah $index',
                              locationAddress: 'Alamat Tanah $index',
                              imageUrl: 'assets/images/tanah.jpg',
                            ),
                          ),
                        );
                      },
